...
rows.export_to_csv(table_to, "clean_data3_no_color_no_breed_no_freeday_cat.csv")
...
rows.export_to_csv(table_to, "clean_data3_no_color_no_breed_no_freeday_dog.csv")
...
rows.export_to_csv(table_to, "clean_data3_no_color_no_breed_no_freeday_cat_test.csv")
...
rows.export_to_csv(table_to, "clean_data3_no_color_no_breed_no_freeday_dog_test.csv")