...
dog_testset.export_prob_predictions_to_csv('random_forest_no_breed.csv', cat_testset.ids + dog_testset.ids, list(predictions_on_cats) + list(predictions_on_dogs))