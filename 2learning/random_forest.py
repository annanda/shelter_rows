...
cat_testset = AnimalTestDataset("../0cleaning/clean_data3_cat_test.csv")
...
dog_testset = AnimalTestDataset("../0cleaning/clean_data3_dog_test.csv")
...
dog_testset.export_exact_predictions_to_csv(cat_testset.ids + dog_testset.ids, list(predictions_on_cats) + list(predictions_on_dogs))